      ...
      <div className="w-full max-w-md bg-[#18181b] rounded-2xl shadow-lg p-8">
        ...
        <div className="flex flex-col gap-3 mb-6">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-white text-black rounded-lg py-2 font-semibold hover:bg-gray-100 transition"
          >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-gray-900 text-white rounded-lg py-2 font-semibold hover:bg-gray-800 transition"
          >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-[#4A154B] text-white rounded-lg py-2 font-semibold hover:bg-[#3a113b] transition"
          >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full bg-sky-500 hover:bg-sky-600 text-white rounded-lg py-2 font-semibold transition"
          >
            Sign in with Email
          </button>
        </form>
